function assoc_ppsl = SampleBridgeAssoc(Set, j, t, L, b, Observs, FLAG_ns)
%SAMPLEBRIDGEASSOC Sample associations in a bridging region from
% t-L+1:t-L+b

global Par;

assoc_ppsl = zeros(Set.N, L);
...
if Set.tracks{j}.death <= t-L+1
    ...
    for tt = t-L+b:-1:t-L+1
        ...
        % Probability
        assoc_ppsl(j, k) = assoc_ppsl(j, k) + log(ppsl_weights(ass));
